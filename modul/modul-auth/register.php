            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
              <div class="card card-plain">
                <div class="card-header">
                  <h4 class="font-weight-bolder">Registrasi masyarakat</h4>
                  <p class="mb-0">Masukkan data untuk registrasi/p>
                </div>
                <div class="card-body">
                  <form role="form">
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-2 text-sm mx-auto">
                    ...
                    <a href="../modul/index.php" class="text-primary text-gradient font-weight-bold">Masuk disini</a>
                  </p>
                </div>
              </div>
            </div>
